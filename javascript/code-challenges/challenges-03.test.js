...
const typeNum = (arr) => {
  // Solution code here...
  return arr.filter((arrItem)=> typeof arrItem === "number");
};
...
const containsAnd = (arr) => {
  // Solution code here...
  let newArr = arr.filter((string)=> string.includes("and"));
  return newArr;
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let newArr = arr.filter(elements=> !forbiddenValues.includes(elements));
  return newArr;
};
