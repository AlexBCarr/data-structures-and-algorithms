...
const containsWorld = (input) => {
  // Solution code here...
  let containsWorld = /(world)/g;
  return containsWorld.test(input);
};
...
const isCapitalized = (str) => {
  // Solution code here...
  let isCapitalized = /[A-Z][a-zA-Z]*/g;
  let words = str.match(isCapitalized);
  return words|| [];
};
...
const citiesAtoJ = (arr) => {
  // Solution code here...
  let citiesAtoJ = /[A-J][a-jA-J]*/g;
  let city = arr.match(citiesAtoJ);
  return city|| [];
};
